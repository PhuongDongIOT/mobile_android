...
public class OrderStateDeliveryAdapter extends BaseAdapter<OrderStateModel, ItemConfirmOrderBinding> {

    private final OrderStatus orderStatus;
    private final boolean isHideCheckbox;
    private List<OrderStateModel> itemList;

    public OrderStateDeliveryAdapter(List<OrderStateModel> itemList, OnItemClick<OrderStateModel> listener, OrderStatus status, boolean isHideCheckbox) {
